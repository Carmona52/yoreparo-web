...
const navItems = [
    {label: "Inicio", icon: <DashboardIcon/>, href: "/home/user"},
    {label: "Cotizaciones", icon: <BuildIcon/>, href: "/home/user/cotizaciones"},
    {label: "Servicios", icon: <BuildIcon/>, href: "/home/user/servicios"},
...
export default function DashboardLayout({children}: { children: React.ReactNode }) {
    ...
    function NavItem({item}: { item: typeof navItems[0] }) {
        const isActive = pathname === item.href || (item.href !== '/home/user' && pathname.startsWith(`${item.href}/`));
